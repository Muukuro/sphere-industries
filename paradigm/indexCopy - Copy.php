...
?>
	...
	<script type="text/javascript" src="js/jquery.zaccordion.js"></script>
		...
		<div class="left full">
			...
			<div class="front-slider">
				<div class="frame0 frame1">
					<div class="content left">
						...
						<p>Sphere Industries will help you achieve your goals.</p>
					</div>
				</div>
				<div class="frame0 frame2">
					<div class="content right">
						<h3>TerraSafe&trade;</h3>
						<p>Live wherever you want, making life special.</p>
					</div>
				</div>
				...
				<div class="frame0 frame4">
					<div class="content right">
						...
						<p>No more limits of where you can be.</p>
					</div>
				</div>
			...
			<h2>Latest press article</h2>
				<ul class="articles" style="margin-top: 5px;">
