...
<title><?php
	...
	$page = ucwords($page);
	$base = "Typhon Advanced Defence Systems :: ";
	if(dirname($_SERVER['PHP_SELF']) != '/typhon'):
		$base = "Typhon :: ";
	endif;
	switch($page) {
		case "Index":
...
<div class="header">
	<div class="logo"><a href="http://typhon.sphere-industries.com"><img src="<?php echo $root; ?>img/typhon_logosmall.png" width="450px" /></a></div>
</div>
<div class="body">
	<div class="mainmenu">
		<ul>
			<li><a href="http://typhon.sphere-industries.com" <?php if($array[1] == ''): ?> class="current" <?php endif ?>>Home</a></li>
			<li><a href="http://typhon.sphere-industries.com/products" <?php if($array[1] == 'products'): ?> class="current" <?php endif ?>>Products</a></li>
			<li><a href="http://typhon.sphere-industries.com/research" <?php if($array[1] == 'research'): ?> class="current" <?php endif ?>>Research</a></li>
			<li><a href="http://typhon.sphere-industries.com/history" <?php if($array[1] == 'history'): ?> class="current" <?php endif ?>>History</a></li>
			<li><a href="http://typhon.sphere-industries.com/about" <?php if($array[1] == 'about'): ?> class="current" <?php endif ?>>About</a></li>
		</ul>
	</div>
	<div class="main">