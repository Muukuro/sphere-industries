			...
			// Settings
				settings: {
					...
					// Desktop only
						...
						scrollFactor:		1.7,			// Scales the scroll delta (1 = normal, 2 = double, 0.5 = half, etc.)
						...
						thumbDelay:			200,		// Delay (in ms) before showing thumbnails
						thumbDelaySpread:	1100,		// Spread (in ms) to randomly stagger thumbnails (0 = don't stagger)
