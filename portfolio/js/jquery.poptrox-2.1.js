	...
	jQuery.fn.poptrox = function(options) {
		...
		// Settings
			...
			var settings = jQuery.extend({
					...
					popupBackgroundColor:			'#333333',						// (Default Style) Popup background color (when usePopupStyling = true)
					popupTextColor:					'#000000',						// (Default Style) Popup text color (when usePopupStyling = true)
					popupLoaderTextSize:			'2em',							// (Default Style) Popup loader text size
					popupCloserBackgroundColor:		'#000000',						// (Default Style) Popup closer background color (when usePopupStyling = true)
					popupCloserTextColor:			'#333333',						// (Default Style) Popup closer text color (when usePopupStyling = true)
